...
source_index=-1, 131.4M params) except window=8 applied UNIFORMLY to every attention surface
(was 2):
...
density. Not swept/tuned beyond the window value itself.
    ...
    uv run python summformer_jax/lm/train.py --config configs/thin512_win8_allfuse8.py
"""
pos_method = "rope"
...
main_window = 8
fuse_stages = tuple(
    ((-1, i), (2, 8), (1, None, None, 8)) for i in range(1, 9)
)
batch_size = 4
