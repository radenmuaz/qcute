...
source_index=-1, 131.4M params) except window=4 applied UNIFORMLY to every attention surface
(was 2):
...
density. Not swept/tuned beyond the window value itself.
    ...
    uv run python summformer_jax/lm/train.py --config configs/thin512_win4_allfuse8.py
"""
pos_method = "rope"
...
main_window = 4
fuse_stages = tuple(
    ((-1, i), (2, 4), (1, None, None, 4)) for i in range(1, 9)
)
batch_size = 4
