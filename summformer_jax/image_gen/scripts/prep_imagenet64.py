...
fail to decode are skipped and counted, not silently dropped without a trace.
    ...
    uv run python scripts/jax/prep_imagenet64.py --split train --out_dir /dev/shm/imagenet64
    uv run python scripts/jax/prep_imagenet64.py --split validation --out_dir /dev/shm/imagenet64
"""
