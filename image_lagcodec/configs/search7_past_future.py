"""
uv run python3 -m image_lagcodec.run_lagcodec --config image_lagcodec/configs/search7_past_future.py

8-way random search off run_1.py (top_level_trainable base), chat 2026-09-17. Ablates attn_lookahead=0, decode_past=2, decode_future=2 on level0 (2^3 factorial across search1-8, this is run 7/8).
"""
