"""
uv run python3 -m image_lagcodec.run_lagcodec --config image_lagcodec/configs/run18.py
"""
# Deep (DEPTH=4, stride=2) analog of run15.py: "full lazy, wait for the whole level" -- decoder_ncodes=1,
