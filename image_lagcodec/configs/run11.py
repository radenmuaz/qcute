"""
uv run python3 -m image_lagcodec.run_lagcodec --config image_lagcodec/configs/run11.py
"""
...
batch_size = 8
val_batch_size = 8
level_steps = (30_000, 30_000, 30_000, 30_000)  # same, longer, every phase
seed = 0
# warmup_steps = 2
train_subset_n = None
val_subset_n = None
...
lr_schedule = "cosine"
lr_min = 1e-5
lr_min_step = 115_000  # near the end of all 4 phases (120k total)
