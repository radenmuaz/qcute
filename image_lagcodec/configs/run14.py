"""
uv run python3 -m image_lagcodec.run_lagcodec --config image_lagcodec/configs/run14.py
"""
# Fork of run1.py: "fully AR eager, 1 ncode" -- decoder_ncodes=1 (finest possible groups), stream_chunks=0
