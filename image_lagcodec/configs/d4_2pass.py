"""
uv run python3 -m image_lagcodec.run_lagcodec --config image_lagcodec/configs/d4_2pass.py
"""
# Deep (DEPTH=4, stride=2) analog of d2_2pass.py: "2 real dependent passes" -- decoder_ncodes = n_blocks/2 per
