...
configs/qcute_refine_v4_5_k1_k1_w32.py) at the same tiny scale as
...
since there's no compression to reason about).
    ...
    uv run python -m qcute.qcute_refine_v4_5 --config configs/qcute_refine_v4_5_overfit10k_k1_k1_l1.py

    # watch live:
    tail -f logs/qcute_refine_v4_5_overfit10k_k1_k1_l1/run.log
"""
