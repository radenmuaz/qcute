"""v4_5_1 (LM-continuation self-code decode) x k1_k1 x gumbel=on grid
...
continuation" section for the design. cross_track_source="decode", decode_code_ste=False (detach).
    ...
    uv run python -m qcute.qcute_refine_v4_5_1 --config configs/qcute_refine_v4_5_1_nosharegrid_k1_k1.py

    # watch live:
    tail -f logs/qcute_refine_v4_5_1_nosharegrid_k1_k1/run.log
"""
