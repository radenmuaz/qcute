...
uv run python -m qcute.archive3.qcute_v5_concat_bos --config configs/qcute_v5_concat_bos_3.py

# plot after training:
uv run python scripts/plot_run.py logs/qcute_v5_concat_bos_3
"""
