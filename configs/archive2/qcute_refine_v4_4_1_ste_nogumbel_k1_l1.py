"""qcute_refine_v4_4_1_ste_k1_l1.py twin with use_gumbel_noise=True -> False, gumbel_tau=2.0 -> 1.0
...
found in ste_k1_l1. See docs/status.md.
    ...
    uv run python -m qcute.qcute_refine_v4_4_1 --config configs/qcute_refine_v4_4_1_ste_nogumbel_k1_l1.py
"""
