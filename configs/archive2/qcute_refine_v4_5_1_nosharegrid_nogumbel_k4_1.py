"""v4_5_1 (LM-continuation self-code decode) x k4_1 x gumbel=off grid
...
continuation" section for the design. cross_track_source="decode", decode_code_ste=False (detach).
    ...
    uv run python -m qcute.qcute_refine_v4_5_1 --config configs/qcute_refine_v4_5_1_nosharegrid_nogumbel_k4_1.py

    # watch live:
    tail -f logs/qcute_refine_v4_5_1_nosharegrid_nogumbel_k4_1/run.log
"""
