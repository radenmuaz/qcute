...
train"). Same architecture family as configs/qcute_refine_v4_4_bpelike_k4_1_crosstrack_decode.py (the v4.4 original)
...
decode_code_ste=False throughout):
  - qcute_refine_v4_5_overfit10k_k4_1_l2.py   (this config's n_layers=2 twin)
  - qcute_refine_v4_5_overfit10k_k1_k1_l1.py / _l2.py   (degenerate Ks=(1,1), no compression)
  - qcute_refine_v4_5_overfit10k_k1_l1.py / _l2.py      (degenerate 1-level Ks=(1,))
  - configs/bytelm_overfit10k_l1.py / _l2.py  (qcute.bytelm baseline, same n_bytes/steps/depth)

    uv run python -m qcute.qcute_refine_v4_5 --config configs/qcute_refine_v4_5_overfit10k_k4_1_l1.py

    # watch live:
    tail -f logs/qcute_refine_v4_5_overfit10k_k4_1_l1/run.log
"""
