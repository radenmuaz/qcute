"""qcute_v5_concat_gumbel: gumbel-noise softmax quantization (code_sample_mode="sample") variant of
configs/qcute_v5_concat_3.py, otherwise identical (Ks=(1,), context_len=256, attn_window=(256,)).
...
uv run python -m qcute.qcute_v5_concat --config configs/qcute_v5_concat_gumbel.py

# plot after training:
uv run python scripts/plot_run.py logs/qcute_v5_concat_gumbel
"""
