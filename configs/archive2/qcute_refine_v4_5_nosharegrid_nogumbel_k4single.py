...
decode_code_ste stays False (detach, unchanged).
    ...
    uv run python -m qcute.qcute_refine_v4_5 --config configs/qcute_refine_v4_5_nosharegrid_nogumbel_k4single.py

    # watch live:
    tail -f logs/qcute_refine_v4_5_nosharegrid_nogumbel_k4single/run.log
"""
