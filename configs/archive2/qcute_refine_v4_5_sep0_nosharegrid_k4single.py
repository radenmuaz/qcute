...
track) -- decode_stage_extra_total is always zero here (no intermediate stages possible).
    ...
    uv run python -m qcute.qcute_refine_v4_5 --config configs/qcute_refine_v4_5_sep0_nosharegrid_k4single.py

    # watch live:
    tail -f logs/qcute_refine_v4_5_sep0_nosharegrid_k4single/run.log
