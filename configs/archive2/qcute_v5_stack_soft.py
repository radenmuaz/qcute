"""qcute_v5_stack_soft: plain Gumbel-Softmax relaxation (code_sample_mode="soft" -- Jang et al.
2016: gumbel-noise softmax used directly in the forward pass, no hard one-hot/straight-through)
variant of configs/qcute_v5_stack_3.py, otherwise identical (Ks=(1,), context_len=256,
attn_window=(256,)). Sibling of configs/qcute_v5_stack_gumbel.py (code_sample_mode="sample" --
...
uv run python -m qcute.qcute_v5_stack --config configs/qcute_v5_stack_soft.py

# plot after training:
uv run python scripts/plot_run.py logs/qcute_v5_stack_soft
"""
