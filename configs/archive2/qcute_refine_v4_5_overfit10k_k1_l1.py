...
higher level at all -- same shape as configs/qcute_refine_v4_5_l1_k1.py) at the same tiny scale as
configs/qcute_refine_v4_5_overfit10k_k4_1_l1.py (n_bytes=10000, steps=1000). See that file's
...
matching l1_k1.py's own established fast/correct single-track path for this degenerate K==1 case.
    ...
    uv run python -m qcute.qcute_refine_v4_5 --config configs/qcute_refine_v4_5_overfit10k_k1_l1.py

    # watch live:
    tail -f logs/qcute_refine_v4_5_overfit10k_k1_l1/run.log
"""
