"""qcute_refine_v4_5_1_detach_k1_l1.py twin with decode_ntp_weight=0.0 -- isolates encode_lms's
own uncond generation quality under decode_code_ste=False, layers-matched to the ste_uncondonly
pair. See docs/status.md.

    uv run python -m qcute.qcute_refine_v4_5_1 --config configs/qcute_refine_v4_5_1_detach_uncondonly_k1_l1.py
"""
