...
for Ks=(2,1), see docs/qcute_v1_plan.md's open-risks note), not just a soft compression knob.

uv run python -m qcute.qcute_v1.qcute_v1 --decoder_type stack --config configs/v1_stack_simplex/ks21_v64_pq4_overfit10k.py
