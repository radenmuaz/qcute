...
is set via the new (self_window, cross_window) 2-tuple (2026-08-23, qcute_v1.py's _norm_track0):
...
uv run python -m qcute.qcute_v1.qcute_v1 --decoder_type stack --config configs/v1_stack_simplex/ks41_v16pq4_overfit10k_level1_window4.py
