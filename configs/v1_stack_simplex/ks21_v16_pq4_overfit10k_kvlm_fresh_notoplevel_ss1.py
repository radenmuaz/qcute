...
qcute_v1_common.py's Config.encoder_ste_skip_real docstring): every forward pass, level0's decode is
...
uv run python -m qcute.qcute_v1.qcute_v1 --decoder_type stack --config configs/v1_stack_simplex/ks21_v16_pq4_overfit10k_kvlm_fresh_notoplevel_ss1.py
