...
here regardless (only one track, always the final stage).
    ...
    uv run python -m qcute.qcute_refine_v4_5 --config configs/qcute_refine_v4_5_recompute0_nosharegrid_nogumbel_k1.py

    # watch live:
    tail -f logs/qcute_refine_v4_5_recompute0_nosharegrid_nogumbel_k1/run.log
