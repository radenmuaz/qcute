...
uv run python -m qcute.qcute_v5 --decoder_type stack --config configs/qcute_v5_stack_noreg/ks21.py

# plot after training:
uv run python scripts/plot_run.py logs/qcute_v5_stack_noreg_ks21
"""
