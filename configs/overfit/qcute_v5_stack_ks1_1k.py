"""v5_stack, Ks regression grid step 1/12 (simplest->hardest, see CLAUDE.md), Ks=(1,), n_layers=1,
1k-byte testbed (not overfit10k -- n_bytes=1000, deliberately smaller/faster for this grid).

uv run python -m qcute.qcute_v5_stack --config configs/overfit/qcute_v5_stack_ks1_1k.py
"""
