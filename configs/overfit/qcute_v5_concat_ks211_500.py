"""v5_concat, Ks regression grid step 5/12 (simplest->hardest, see CLAUDE.md), Ks=(2,1,1), n_layers=1,
1k-byte testbed (n_bytes=1000), 500 steps.

uv run python -m qcute.qcute_v5_concat_slow --config configs/overfit/qcute_v5_concat_ks211_500.py
"""
