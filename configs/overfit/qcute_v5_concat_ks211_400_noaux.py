"""v5_concat, no-aux 200-step rerun 5/12 (simplest->hardest, see CLAUDE.md), Ks=(2,1,1), n_layers=1,
1k-byte testbed, val_frac=0.5 (avoids short-val-data truncation), decode_self_only_aux=False.

uv run python -m qcute.qcute_v5_concat_slow --config configs/overfit/qcute_v5_concat_ks211_400_noaux.py
"""
