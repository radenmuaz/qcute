"""v5_concat, no-aux 200-step rerun 10/12 (simplest->hardest, see CLAUDE.md), Ks=(2,2,2), n_layers=1,
1k-byte testbed, val_frac=0.5 (avoids short-val-data truncation), decode_self_only_aux=False.

uv run python -m qcute.qcute_v5_concat_slow --config configs/overfit/qcute_v5_concat_ks222_400_noaux.py
"""
