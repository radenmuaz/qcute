"""v5_stack, softmax quant_type, two-level K=(2,1), n_layers=1, gumbel disabled, STE on,
overfit10k testbed. Stress test #2: unequal Ks (level0 K=2, level1 K=1), unlike the k11_l1
baseline's K=(1,1) -- run only after qcute_v5_stack_k11_l1.py passes (see docs/status.md).

uv run python -m qcute.qcute_v5_stack --config configs/overfit/qcute_v5_stack_k21_l1.py
"""
