"""v5_stack_eff, no-aux 400-step rerun 6/12 of the Ks regression grid (simplest->hardest, see
...
uv run python -m qcute.archive3.qcute_v5_bos --config configs/overfit_stack_eff/qcute_v5_stack_eff_ks22_400_noaux.py
"""
