"""qcute.qcutelm_vlt6 grid cell: bsq / aux_recon loss / separate enc-dec.
...
a combination not used in the original design) to isolate use_zero_kv as its own grid dimension.
    ...
    uv run python -m qcute.qcutelm_vlt6 --config configs/qcutelm_vlt6_grid_bsq_aux_encdec_zerokv.py
"""
