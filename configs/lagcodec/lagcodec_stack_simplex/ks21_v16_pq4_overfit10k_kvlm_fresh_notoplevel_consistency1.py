...
2026-08-23, see qcute_lagcodec_common.py's Config.encoder_ste_p/encoder_ste_skip_real docstrings) --
...
uv run python -m qcute.qcute_lagcodec.qcute_lagcodec --decoder_type stack --config configs/lagcodec/lagcodec_stack_simplex/ks21_v16_pq4_overfit10k_kvlm_fresh_notoplevel_consistency1.py
