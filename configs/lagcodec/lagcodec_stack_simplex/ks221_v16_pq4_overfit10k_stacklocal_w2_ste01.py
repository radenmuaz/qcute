...
uv run python -m qcute.qcute_lagcodec.qcute_lagcodec --decoder_type stack_local --config configs/lagcodec/lagcodec_stack_simplex/ks221_v16_pq4_overfit10k_stacklocal_w2_ste01.py
