...
(qcute_lagcodec_common.py): for step < active_srcs_until_step (here steps/2 = 1500), every decode_level call
...
uv run python -m qcute.qcute_lagcodec.qcute_lagcodec --decoder_type stack --config configs/lagcodec/lagcodec_stack_simplex/ks221_v16_pq4_overfit10k_window16_relaxed_ss1_curriculum.py
