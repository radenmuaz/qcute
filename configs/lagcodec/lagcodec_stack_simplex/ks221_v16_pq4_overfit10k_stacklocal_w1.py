...
see StackDecoderLocal's docstring, qcute_lagcodec_decoder.py). The only remaining cross-block
...
uv run python -m qcute.qcute_lagcodec.qcute_lagcodec --decoder_type stack_local --config configs/lagcodec/lagcodec_stack_simplex/ks221_v16_pq4_overfit10k_stacklocal_w1.py
