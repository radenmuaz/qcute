...
(code_context_pass/KVContextLM, qcute_lagcodec_decoder.py, chat 2026-08-22) instead of an isolated
...
uv run python -m qcute.qcute_lagcodec.qcute_lagcodec --decoder_type stack --config configs/lagcodec/lagcodec_stack_simplex/ks21_v256_pq1_overfit10k_kvlm_fresh.py
