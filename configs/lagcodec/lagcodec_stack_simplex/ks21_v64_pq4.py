"""v1_stack_simplex/ks21_v64_pq4: full-scale (full enwik8_1M) run, following the overfit10k
...
uv run python -m qcute.qcute_lagcodec.qcute_lagcodec --decoder_type stack_v1 --config configs/lagcodec/lagcodec_stack_simplex/ks21_v64_pq4.py
