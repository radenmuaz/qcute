...
Gumbel-noise counterpart: qcute_refine_v4_5_nosharegrid_k4_1.py
    ...
    uv run python -m qcute.qcute_refine_v4_5 --config configs/qcute_refine_v4_5_nosharegrid_nogumbel_k4_1.py

    # watch live:
    tail -f logs/qcute_refine_v4_5_nosharegrid_nogumbel_k4_1/run.log
"""
