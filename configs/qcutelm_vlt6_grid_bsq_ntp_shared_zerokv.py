"""qcute.qcutelm_vlt6 grid cell: bsq / main_ntp loss / shared enc-dec.
...
bsq dq=13 -> 2^13=8192 codespace, an exact match to bpelm_8192's vocab
(the same "close to bpe vocab" spirit as ifsq's dq=5 -> 8^5=32768, ~4x
over — bsq hits it exactly since 8192 is a clean power of 2).

    uv run python -m qcute.qcutelm_vlt6 --config configs/qcutelm_vlt6_grid_bsq_ntp_shared_zerokv.py
"""
