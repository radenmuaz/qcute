...
Companion grid cells:
  ...
  - qcute_refine_v4_4_nosharegrid_k1.py    (v4.4, 1 level)
    ...
    uv run python -m qcute.qcute_refine_v4_5 --config configs/qcute_refine_v4_5_recompute0_nosharegrid_k4_1.py

    # watch live:
    tail -f logs/qcute_refine_v4_5_recompute0_nosharegrid_k4_1/run.log
