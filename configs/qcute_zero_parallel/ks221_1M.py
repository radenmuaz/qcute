...
uv run python -m qcute.qcute_zero_parallel.qcute_zero_parallel --config configs/qcute_zero_parallel/ks221_1M.py

# plot after training:
uv run python scripts/plot_run.py logs/qcute_zero_parallel_ks221_1M
"""
from pathlib import Path

run_name = "qcute_zero_parallel_ks221_1M"
Ks = (2, 2, 1)
d_model = 256
n_layers = 4
n_heads = 4
