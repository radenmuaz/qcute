"""v5_concat (v4.4.1-derived) starter config, softmax (default) quant_type, single-level K=4,
overfit10k testbed. See qcute_v5_concat_overfit10k_k4single_bsq.py for the BSQ twin.
