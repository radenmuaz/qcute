...
from qcute.qcute_v1.qcute_v1_common import LM, Config, apply_rope, make_dict, rope_cos_sin
...
class Encoder(nn.Module):
    ...
    def forward(self, seq_repr: torch.Tensor, level: int, window: int | None, compute_ntp: bool = True,
        ...
        level1 sampling gives the next level0 code) -- `generate_level_codes` in qcute_v1_decoder.py
        ...
        actual new bytes. This is docs/qcute_v1_plan.md's "path (b)" (upper-level LM predicts the
