...
self-attn + cross-attn-to-own-code mechanism (see docs/qcute_lagcodec_plan.md); level1 (top) is
...
uv run python -m qcute.qcute_lagcodec.qcute_lagcodec --decoder_type stack_v1 --config configs/lagcodec/lagcodec_stack_simplex/ks21_v256_pq1.py
