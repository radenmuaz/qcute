...
docs/status.md's "real qcute_lagcodec vs qcute_zero differentiator" section -- this run tests whether
...
uv run python -m qcute.qcute_lagcodec.qcute_lagcodec --decoder_type stack --config configs/lagcodec/lagcodec_stack_simplex/ks21_v256_pq1_overfit10k_kvlm_fresh_notoplevel.py
