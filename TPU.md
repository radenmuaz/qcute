...
gcloud compute tpus queued-resources ssh tpu1r --project raden-tpu --zone europe-west4-a
```
...
gcloud compute tpus queued-resources ssh tpu3 --project raden-tpu --zone us-east1-d
```